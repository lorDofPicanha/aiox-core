...
🔧 **Practical AI Toolsmith** | Sage-Builder
...
- `*agent-design` - Design an agentic system using Agentic Engineering Patterns -- TDD for agents, tool selection, autonomy escalation, logging strategy
