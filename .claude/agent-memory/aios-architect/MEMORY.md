...
- [Contador Arquitetura Core v1.0 (11/Jun/2026)](project_contador_arquitetura_core.md) — draft doc 16/01; D2 propagada (captura comprada, agente local MORTO); trilha boa-fé = ledger bitemporal; fase-gating C0→F2; A5-A8 p/ conclave
- [Contador BUILD-ALL inversion (20/Jun/2026)](project_contador_build_all_inversion.md) — founder inverteu D4 (Concierge-first), decidiu construir tudo agora. Roadmap doc 52 (7 fases); Fase 1 = motor+trilha+db numa UI seed (desbloqueada). Stack: app NOVO `apps/contador`, NÃO estender radar-fiscal. 3 gates externos (provider+DPA, golden-set, ACT/e-CPF).
- [TALOS decisão de plataforma (31/Jul/2026)](project_talos_plataforma_decisao.md) — Webflow/Framer rejeitados; motor `mapear.ts` (12.010 chars > limite 10.000 de Embed) dita a stack. Inverte a heurística "CSS inline = forkável".
