...
**Projeto:** Anipis · **Versão 2.0 FINAL** · 19/Mai/2026
**Origem v1:** Patricia Peck Advocacia (recebido 17/Mai/2026)
**Edições v2 aplicadas por:** Squad legal AIOS (Patricia Peck clone + Lucia Savage + Bruce Schneier + Ann Cavoukian + Heather Meeker)
**Status:** ✅ **FINAL — Squad-legal internal sign-off** (sem revisão OAB externa por decisão founder 19/Mai)
**Founder action pendente:** preencher CNPJ + Razão Social + endereço CONTROLADORA (D-3, 27/Mai)

> ⚠️ **Pivot 19/Mai:** Founder decidiu não engajar advogado OAB externo pré-Beta (Patricia ou outro). Bundle assinado internamente pelo squad legal AIOS + founder como DPO interim. Founder assume risco regulatório explícito em audit ANPD eventual. Engajamento OAB reavaliado pós-Beta (Q3/2026).

## Changelog v2 (19/Mai/2026)

- **EDIÇÃO 1** — Cláusula 10.1(a): inserido prazo de 24h + cap absoluto 48h (estava vazio em v1)
- **EDIÇÃO 2** — Anexo I Supabase §F retenção: trocado "5 anos arquivo segregado" (que não existia em código) por descrição veraz da pseudonimização imediata + audit_events 5y (Caminho A — alinha contrato à realidade)
- **EDIÇÃO 3** — Cláusula 12 (autoridades estrangeiras): adicionado item (f) com nomeação explícita de FISA §702, EO 12333, CLOUD Act + exigência de transparency report semestral agregado
- **EDIÇÃO 4** — Cláusula 7.1 (obrigações controladora): adicionado (c.bis) com 5 elementos mínimos do prompt de consentimento destacado Art. 11 I LGPD (implementado em DEV-2 19/Mai)

Detalhamento completo das justificativas: `SCCs-v2-proposed-edits.md`.

## Reverter SCC v2 → v1 (caso Patricia seja engajada futuramente)

Arquivos preservados:
- `SCCs-ANPD-19-2024-draft-v1-PatriciaPeck.md` — original Patricia (sem edições)
- `SCCs-v2-proposed-edits.md` — diff aplicado em v2 (4 edições)
- `SCC-squad-legal-review.md` — review squad legal (395 linhas) que motivou v2

Patricia futuramente pode revisar v2 ou voltar a v1 + comentar inline.
...
- 10.1 Em caso de incidente, OPERADORA notifica CONTROLADORA:
  - **(a)** [EDIÇÃO 1 v2] **em até 24 (vinte e quatro) horas a contar do momento em que tomar ciência inequívoca do incidente, podendo ser prorrogado por escrito por CONTROLADORA quando justificadamente necessário para preservar evidências forenses, sem prejuízo do prazo máximo absoluto de 48 (quarenta e oito) horas para notificação substantiva;**
...
**F. Retenção:** [EDIÇÃO 2 v2 — Caminho A]
