...
function processTaskFile(filename) {
  ...
  const entradaPattern = /\*\*Entrada:\*\*\n- campo: \{TODO: fieldName\}\n {2}tipo: \{TODO: string\|number\|boolean\}\n {2}origem: \{TODO: User Input \| config \| Step X\}\n {2}obrigatório: true\n {2}validação: \{TODO: validation rule\}/;
  ...
  const saidaPattern = /\*\*Saída:\*\*\n- campo: \{TODO: fieldName\}\n {2}tipo: \{TODO: type\}\n {2}destino: \{TODO: output \| state \| Step Y\}\n {2}persistido: true/;
  ...
  const errorPattern = /\*\*Common Errors:\*\*\n\n1\. \*\*Error:\*\* \{TODO: error type\}\n {3}- \*\*Cause:\*\* \{TODO: why it happens\}\n {3}- \*\*Resolution:\*\* \{TODO: how to fix\}\n {3}- \*\*Recovery:\*\* \{TODO: automated recovery steps\}/;
