// Extract Lighthouse scores from PROD revalidation v2 reports (mobile only).
// Sequential to keep memory low.
import { promises as fs } from 'node:fs';
import path from 'node:path';

const dir = path.resolve('docs/qa/lighthouse');
const files = ['home-mobile-prod-v2.json', 'produto-mobile-prod-v2.json', 'contato-mobile-prod-v2.json'];
