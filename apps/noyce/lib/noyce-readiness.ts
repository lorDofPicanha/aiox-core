...
export const sourceGovernance: SourceGovernance[] = [
  ...
  },
  {
    ...
    nextHumanInput: "Confirmar login/certificado via vault, 2FA e permissao de uso automatizado.",
  },
  {
    source: "bnc",
    label: "BNC",
  ...
  },
  {
    ...
    automationStatus: "blocked_until_vault",
    adapterStatus: "manual_import_ready",
    nextHumanInput: "Confirmar URL operacional, perfil, 2FA, certificado e permissao de uso.",
  },
  {
    source: "comprasgov",
    label: "ComprasGov",
    ...
    automationStatus: "blocked_until_vault",
    adapterStatus: "manual_import_ready",
    nextHumanInput: "Confirmar se o fluxo ENIAC usara apenas consulta publica/manual ou area autenticada.",
  },
  {
    source: "sislog",
    label: "SISLOG",
    ...
    automationStatus: "blocked_until_vault",
    adapterStatus: "manual_import_ready",
    nextHumanInput: "Confirmar URL correta, perfil de acesso, 2FA e ToS.",
  },
  {
