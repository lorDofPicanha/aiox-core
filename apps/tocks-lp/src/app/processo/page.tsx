  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-6 text-lg md:text-xl text-text-secondary max-w-lg relative">
        ...
        <div className="relative mt-16 flex gap-12 md:gap-20">
          <div className="text-center">
            <Counter end={8} className="font-heading text-4xl font-semibold text-accent" />
            <p className="text-text-secondary text-xs mt-1 uppercase tracking-wider">etapas</p>
          </div>
          <div className="text-center">
            <Counter end={12} className="font-heading text-4xl font-semibold text-accent" />
            <p className="text-text-secondary text-xs mt-1 uppercase tracking-wider">camadas de verniz</p>
          </div>
          <div className="text-center">
            <Counter end={38} suffix=" anos" className="font-heading text-4xl font-semibold text-accent" />
            <p className="text-text-secondary text-xs mt-1 uppercase tracking-wider">de ofício</p>
          </div>
        </div>
          ...
          >
            <div className="max-w-6xl mx-auto">
              <ScrollReveal>
                ...
                >
                  {/* Image */}
                  <div className={`relative aspect-[4/3] overflow-hidden rounded-sm bg-bg-secondary ${isEven ? '' : 'md:[direction:ltr]'}`}>
                    <Image
                      src={step.image}
                    ...
                    />
                    {/* Step number overlay */}
                    <div className="absolute top-6 left-6 font-heading text-6xl md:text-7xl font-bold text-accent/20">
                      {step.number}
                    </div>
                  </div>
                  ...
                  <div className={isEven ? '' : 'md:[direction:ltr]'}>
                    ...
                    <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl font-semibold text-text-primary mt-4">
                      {step.title}
                    </h2>
      ...
      {/* Final CTA */}
      <section className="py-32 md:py-48 px-6 text-center bg-bg-secondary">
        <ScrollReveal>
          <div>
