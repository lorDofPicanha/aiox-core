...
const STEPS = [
  {
    ...
    description:
      'Escolhemos cada tronco pela densidade, veio e resistencia. Trabalhamos com madeiras nobres como Peroba, Cedrinho e Cumaru — cada peca e unica.',
    image: '/images/products/Mesa-de-Sinuca-Rustic-Madeira-Maciça---001.jpg',
  },
  {
    number: '02',
    title: 'Corte e Preparacao',
    description:
      'Cortes precisos respeitando a fibra natural da madeira. A secagem controlada garante estabilidade por decadas.',
  ...
  },
  {
    ...
    title: 'Marcenaria',
    description:
      'Encaixes artesanais que garantem estrutura por geracoes. Tecnicas transmitidas de Martinho a Milton, e agora a nova geracao.',
  ...
  },
  {
    ...
    title: 'Montagem',
    description:
      'Cada peca e unida com tecnica e paciencia. A estrutura e testada em cada etapa para assegurar solidez absoluta.',
  ...
  },
  {
    ...
    title: 'Acabamento',
    description:
      '12 camadas de verniz, lixadas a mao entre cada aplicacao. O resultado e um toque sedoso e uma protecao que dura anos.',
    image: '/images/products/Mesa-de-Bilhar-Curve-001.jpg',
  },
  {
    number: '06',
    title: 'Instalacao do Pano',
    description:
      'Pano de competicao esticado sobre ardosia calibrada. A tensao e ajustada milimetricamente para rolamento perfeito.',
  ...
  },
  {
    ...
    description:
      'Cada mesa e testada e inspecionada antes da entrega. Verificamos nivelamento, acabamento, encaixes e rolamento da bola.',
  ...
  },
  {
    ...
    description:
      'Nossa equipe instala, nivela e orienta os cuidados. Voce recebe sua mesa pronta para jogar, com garantia total.',
    ...
    <>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-6 text-lg md:text-xl text-[var(--color-text-secondary)] max-w-lg relative">
          Semanas de trabalho manual. 8 etapas de excelencia artesanal.
        </p>
        ...
        <div className="relative mt-16 flex gap-12 md:gap-20">
          ...
          <div className="text-center">
            ...
            <p className="text-[var(--color-text-secondary)] text-xs mt-1 uppercase tracking-wider">de oficio</p>
          </div>
        </div>
        ...
        <ScrollReveal>
          <div>
            ...
            <h2 className="font-[family-name:var(--font-heading)] text-3xl md:text-4xl lg:text-5xl font-semibold text-[var(--color-text-primary)] mt-4">
              Quer acompanhar a fabricacao da sua mesa?
            </h2>
            ...
            <div className="mt-10">
              <Button
                variant="whatsapp"
                size="lg"
                href={getWhatsAppUrlCustom('Ola! Quero entender o processo de fabricacao de uma mesa personalizada.')}
