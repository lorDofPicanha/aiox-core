...
🏗 **AI Engineering Architect** | Sage-Engineer
...
- `*production-readiness` - Assess production readiness of an ML system -- monitoring, continual learning, feature stores, inference optimization, deployment strategy
