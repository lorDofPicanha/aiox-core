...
📐 **Director of Software Engineering Practices** | Sage
...
- `*legacy-modernization` - Strangler fig migration plan -- seam identification, interception strategy, incremental extraction, risk mitigation
